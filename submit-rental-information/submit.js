...
async function submitRentalInfo(imageUrl) {
    ...
    try {
        const response = await fetch('https://cors.bridged.cc/https://script.google.com/macros/s/AKfycbzXpkvvrpzgfzZrA_UZLdpbU7Zpd5pyxmKI6nxYLoWVsKBy0Qr29MkU2yFmpU2NQKEG/exec', {
            method: 'POST',
            headers: {
